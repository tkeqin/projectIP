    ...
    <div class="card">
        ...
        <form id="assessmentForm" action="${pageContext.request.contextPath}/student/assessment/submit" method="post">
            ...
            <div class="question-container" data-question="1">
                ...
                <div class="options">
                    <div class="option"><input type="radio" id="q1_1" name="answers" value="5" required><label for="q1_1" class="option-label">Never</label></div>
                    <div class="option"><input type="radio" id="q1_2" name="answers" value="4"><label for="q1_2" class="option-label">Rarely</label></div>
                    <div class="option"><input type="radio" id="q1_3" name="answers" value="3"><label for="q1_3" class="option-label">Sometimes</label></div>
                    <div class="option"><input type="radio" id="q1_4" name="answers" value="2"><label for="q1_4" class="option-label">Often</label></div>
                    <div class="option"><input type="radio" id="q1_5" name="answers" value="1"><label for="q1_5" class="option-label">Always</label></div>
                </div>
            </div>
            <div class="question-container" data-question="2" style="display:none;">
                ...
                <div class="options">
                    <div class="option"><input type="radio" id="q2_1" name="answers" value="5"><label for="q2_1" class="option-label">Not at all</label></div>
                    ...
                    <div class="option"><input type="radio" id="q2_5" name="answers" value="1"><label for="q2_5" class="option-label">Constantly</label></div>
                </div>
            </div>
            <div class="question-container" data-question="3" style="display:none;">
                ...
                <div class="options">
                    <div class="option"><input type="radio" id="q3_1" name="answers" value="5"><label for="q3_1" class="option-label">Not at all</label></div>
                    <div class="option"><input type="radio" id="q3_2" name="answers" value="4"><label for="q3_2" class="option-label">Slightly</label></div>
                    <div class="option"><input type="radio" id="q3_3" name="answers" value="3"><label for="q3_3" class="option-label">Moderately</label></div>
                    <div class="option"><input type="radio" id="q3_4" name="answers" value="2"><label for="q3_4" class="option-label">Significantly</label></div>
                    <div class="option"><input type="radio" id="q3_5" name="answers" value="1"><label for="q3_5" class="option-label">Severely</label></div>
                </div>
            </div>
            <div class="question-container" data-question="4" style="display:none;">
                <div class="question-title">Can you control your anxiety?</div>
                <div class="options">
                    <div class="option"><input type="radio" id="q4_1" name="answers" value="5"><label for="q4_1" class="option-label">Completely</label></div>
                    <div class="option"><input type="radio" id="q4_2" name="answers" value="4"><label for="q4_2" class="option-label">Mostly</label></div>
                    <div class="option"><input type="radio" id="q4_3" name="answers" value="3"><label for="q4_3" class="option-label">Somewhat</label></div>
                    <div class="option"><input type="radio" id="q4_4" name="answers" value="2"><label for="q4_4" class="option-label">Barely</label></div>
                    <div class="option"><input type="radio" id="q4_5" name="answers" value="1"><label for="q4_5" class="option-label">Not at all</label></div>
                </div>
            </div>
            <div class="question-container" data-question="5" style="display:none;">
                ...
                <div class="options">
                    <div class="option"><input type="radio" id="q5_1" name="answers" value="5"><label for="q5_1" class="option-label">No anxiety</label></div>
                    <div class="option"><input type="radio" id="q5_2" name="answers" value="4"><label for="q5_2" class="option-label">Mild</label></div>
                    <div class="option"><input type="radio" id="q5_3" name="answers" value="3"><label for="q5_3" class="option-label">Moderate</label></div>
                    <div class="option"><input type="radio" id="q5_4" name="answers" value="2"><label for="q5_4" class="option-label">Severe</label></div>
                    <div class="option"><input type="radio" id="q5_5" name="answers" value="1"><label for="q5_5" class="option-label">Very severe</label></div>
                </div>
            </div>
            <div class="buttons">
